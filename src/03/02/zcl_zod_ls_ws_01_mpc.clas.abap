class ZCL_ZOD_LS_WS_01_MPC definition
  public
...
CLASS ZCL_ZOD_LS_WS_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZOD_LS_WS_01_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20201208125907'.                  "#EC NOTEXT
