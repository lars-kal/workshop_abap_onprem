class ZCL_ZLSWS_OD_02_MPC definition
  public
...
CLASS ZCL_ZLSWS_OD_02_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZLSWS_OD_02_SRV' ).
...
lo_property = lo_entity_type->create_property( iv_property_name = 'Ident' iv_abap_fieldname = 'IDENT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZLSWS_OD_02_MPC=>TS_FILE' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210414124754'.                  "#EC NOTEXT
